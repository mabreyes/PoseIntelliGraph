...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type="Pretrained", prefix="backbone.", checkpoint=backbone_path),
    ),
    neck=dict(
        type="CSPNeXtPAFPN",
...
halpe_coco133 = (
    ...
    + [(20, 17), (21, 20), (22, 18), (23, 21), (24, 19), (25, 22)]
    + [(i, i - 3) for i in range(26, 136)]
)
...
dataset_aic = dict(
    ...
    pipeline=[
        dict(type="KeypointConverter", num_keypoints=num_keypoints, mapping=aic_coco133)
    ],
)
...
dataset_mpii = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=mpii_coco133
        )
    ],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=jhmdb_coco133
        )
    ],
)
...
dataset_halpe = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=halpe_coco133
        )
    ],
)
...
wflw_coco133 = (
    [(i * 2, 23 + i) for i in range(17)]
    + [(33 + i, 40 + i) for i in range(5)]
    + [(42 + i, 45 + i) for i in range(5)]
    + [(51 + i, 50 + i) for i in range(9)]
    + [
        (60, 59),
        (61, 60),
        (63, 61),
...
dataset_wflw = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=wflw_coco133
        ),
        *face_pipeline,
    ],
)
...
dataset_cofw = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=cofw_coco133
        ),
        *face_pipeline,
    ],
)
...
dataset_lapa = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=lapa_coco133
        ),
        *face_pipeline,
    ],
)
