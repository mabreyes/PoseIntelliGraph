...
def mmpose_to_openpose_visualization(args, img_path, detector, pose_estimator):
    ...
    # save image
    out_file = "openpose_" + os.path.splitext(os.path.basename(img_path))[0] + ".png"
...
def main():
    ...
    parser.add_argument(
        "--bbox-thr", type=float, default=0.4, help="Bounding box score threshold"
    )
    parser.add_argument(
    ...
    if input_type == "image":
        mmpose_to_openpose_visualization(args, args.input, detector, pose_estimator)
