...
dataset_coco = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=coco_halpe26
        )
    ],
)
...
dataset_aic = dict(
    ...
    pipeline=[
        dict(type="KeypointConverter", num_keypoints=num_keypoints, mapping=aic_halpe26)
    ],
)
...
dataset_mpii = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=mpii_halpe26
        )
    ],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[
        dict(
            type="KeypointConverter", num_keypoints=num_keypoints, mapping=jhmdb_halpe26
        )
    ],
)
...
# hooks
default_hooks = dict(checkpoint=dict(save_best="AUC", rule="greater", max_keep_ckpts=1))
