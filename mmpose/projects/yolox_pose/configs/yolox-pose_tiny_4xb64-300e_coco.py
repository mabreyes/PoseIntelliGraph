...
train_pipeline_stage1 = [
    *pre_transform,
    ...
    dict(type="FilterDetPoseAnnotations", min_gt_bbox_wh=(1, 1), keep_empty=False),
    dict(
...
test_pipeline = [
    *pre_transform,
    ...
    dict(type="mmdet.Pad", pad_to_square=True, pad_val=dict(img=(114.0, 114.0, 114.0))),
    dict(
        type="PackDetPoseInputs",
        meta_keys=(
            "id",
...
train_dataloader = dict(batch_size=64, dataset=dict(pipeline=train_pipeline_stage1))
