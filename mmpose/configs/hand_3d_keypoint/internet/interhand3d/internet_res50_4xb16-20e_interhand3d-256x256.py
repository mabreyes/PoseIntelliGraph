...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        camera_param_file="annotations/machine_annot/" "InterHand2.6M_val_camera.json",
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file="annotations/all/" "InterHand2.6M_test_data.json",
        camera_param_file="annotations/all/" "InterHand2.6M_test_camera.json",
        joint_file="annotations/all/" "InterHand2.6M_test_joint_3d.json",
        use_gt_root_depth=True,
        rootnet_result_file=None,
        data_mode=data_mode,
        data_root=data_root,
