...
dataset_coco = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=coco_crowdpose)],
)
...
dataset_aic = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=aic_crowdpose)],
)
...
dataset_mpii = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=14, mapping=mpii_crowdpose)],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[
        dict(type="KeypointConverter", num_keypoints=14, mapping=jhmdb_crowdpose)
    ],
)
...
dataset_halpe = dict(
    ...
    pipeline=[
        dict(type="KeypointConverter", num_keypoints=14, mapping=halpe_crowdpose)
    ],
)
...
dataset_posetrack = dict(
    ...
    pipeline=[
        dict(type="KeypointConverter", num_keypoints=14, mapping=posetrack_crowdpose)
    ],
)
