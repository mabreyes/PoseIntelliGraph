...
dataset_aic = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=aic_coco)],
)
...
dataset_crowdpose = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=crowdpose_coco)],
)
...
dataset_mpii = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=mpii_coco)],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=jhmdb_coco)],
)
...
dataset_halpe = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=halpe_coco)],
)
...
dataset_posetrack = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=posetrack_coco)],
)
...
val_ochuman = dict(
    ...
    pipeline=[dict(type="KeypointConverter", num_keypoints=17, mapping=ochuman_coco)],
)
...
test_evaluator = [dict(type="PCKAccuracy", thr=0.1), dict(type="AUC"), dict(type="EPE")]
