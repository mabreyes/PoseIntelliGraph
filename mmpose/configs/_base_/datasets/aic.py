dataset_info = dict(
    ...
    keypoint_info={
        ...
        4: dict(
            name="left_elbow", id=4, color=[0, 255, 0], type="upper", swap="right_elbow"
        ),
        5: dict(
            name="left_wrist", id=5, color=[0, 255, 0], type="upper", swap="right_wrist"
        ),
        6: dict(
            name="right_hip", id=6, color=[255, 128, 0], type="lower", swap="left_hip"
        ),
        7: dict(
            name="right_knee", id=7, color=[255, 128, 0], type="lower", swap="left_knee"
        ),
        8: dict(
            name="right_ankle",
            id=8,
        ...
        9: dict(
            name="left_hip", id=9, color=[0, 255, 0], type="lower", swap="right_hip"
        ),
        10: dict(
            name="left_knee", id=10, color=[0, 255, 0], type="lower", swap="right_knee"
        ),
        11: dict(
            name="left_ankle",
            id=11,
        ...
        12: dict(name="head_top", id=12, color=[51, 153, 255], type="upper", swap=""),
        13: dict(name="neck", id=13, color=[51, 153, 255], type="upper", swap=""),
    },
    skeleton_info={
        0: dict(link=("right_wrist", "right_elbow"), id=0, color=[255, 128, 0]),
        1: dict(link=("right_elbow", "right_shoulder"), id=1, color=[255, 128, 0]),
        ...
        12: dict(link=("right_shoulder", "right_hip"), id=12, color=[51, 153, 255]),
        13: dict(link=("left_shoulder", "left_hip"), id=13, color=[51, 153, 255]),
    },
    joint_weights=[
        1.0,
        1.2,
