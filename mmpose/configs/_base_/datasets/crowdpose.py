dataset_info = dict(
    ...
    keypoint_info={
        ...
        5: dict(
            name="right_wrist", id=5, color=[0, 255, 0], type="upper", swap="left_wrist"
        ),
        6: dict(
            name="left_hip", id=6, color=[255, 128, 0], type="lower", swap="right_hip"
        ),
        7: dict(
            name="right_hip", id=7, color=[0, 255, 0], type="lower", swap="left_hip"
        ),
        8: dict(
            name="left_knee", id=8, color=[255, 128, 0], type="lower", swap="right_knee"
        ),
        9: dict(
            name="right_knee", id=9, color=[0, 255, 0], type="lower", swap="left_knee"
        ),
        10: dict(
            name="left_ankle",
            id=10,
