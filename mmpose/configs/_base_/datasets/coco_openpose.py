dataset_info = dict(
    ...
    keypoint_info={
        ...
        8: dict(
            name="right_hip", id=8, color=[0, 255, 170], type="lower", swap="left_hip"
        ),
        9: dict(
            name="right_knee", id=9, color=[0, 255, 255], type="lower", swap="left_knee"
        ),
        10: dict(
            name="right_ankle",
            id=10,
        ...
        11: dict(
            name="left_hip", id=11, color=[0, 85, 255], type="lower", swap="right_hip"
        ),
        12: dict(
            name="left_knee", id=12, color=[0, 0, 255], type="lower", swap="right_knee"
        ),
        13: dict(
            name="left_ankle",
            id=13,
        ...
        14: dict(
            name="right_eye", id=14, color=[170, 0, 255], type="upper", swap="left_eye"
        ),
        15: dict(
            name="left_eye", id=15, color=[255, 0, 255], type="upper", swap="right_eye"
        ),
        16: dict(
            name="right_ear", id=16, color=[255, 0, 170], type="upper", swap="left_ear"
        ),
        17: dict(
            name="left_ear", id=17, color=[255, 0, 85], type="upper", swap="right_ear"
        ),
    },
    skeleton_info={
