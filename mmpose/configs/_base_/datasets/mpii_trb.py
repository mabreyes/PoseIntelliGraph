dataset_info = dict(
    ...
    keypoint_info={
        ...
        2: dict(
            name="left_elbow", id=2, color=[0, 255, 0], type="upper", swap="right_elbow"
        ),
        3: dict(
            name="right_elbow",
            id=3,
        ...
        4: dict(
            name="left_wrist", id=4, color=[0, 255, 0], type="upper", swap="right_wrist"
        ),
        5: dict(
            name="right_wrist",
            id=5,
        ...
        6: dict(
            name="left_hip", id=6, color=[0, 255, 0], type="lower", swap="right_hip"
        ),
        7: dict(
            name="right_hip", id=7, color=[255, 128, 0], type="lower", swap="left_hip"
        ),
        8: dict(
            name="left_knee", id=8, color=[0, 255, 0], type="lower", swap="right_knee"
        ),
        9: dict(
            name="right_knee", id=9, color=[255, 128, 0], type="lower", swap="left_knee"
        ),
        10: dict(
            name="left_ankle",
            id=10,
        ...
        12: dict(name="head", id=12, color=[51, 153, 255], type="upper", swap=""),
        13: dict(name="neck", id=13, color=[51, 153, 255], type="upper", swap=""),
        14: dict(
            name="right_neck",
            id=14,
            color=[255, 255, 255],
    ...
    skeleton_info={
        ...
        4: dict(link=("right_shoulder", "right_elbow"), id=4, color=[255, 128, 0]),
        5: dict(link=("left_elbow", "left_wrist"), id=5, color=[0, 255, 0]),
        6: dict(link=("right_elbow", "right_wrist"), id=6, color=[255, 128, 0]),
        7: dict(link=("left_shoulder", "left_hip"), id=7, color=[51, 153, 255]),
        8: dict(link=("right_shoulder", "right_hip"), id=8, color=[51, 153, 255]),
        9: dict(link=("left_hip", "right_hip"), id=9, color=[51, 153, 255]),
        10: dict(link=("left_hip", "left_knee"), id=10, color=[0, 255, 0]),
        11: dict(link=("right_hip", "right_knee"), id=11, color=[255, 128, 0]),
        12: dict(link=("left_knee", "left_ankle"), id=12, color=[0, 255, 0]),
        13: dict(link=("right_knee", "right_ankle"), id=13, color=[255, 128, 0]),
        14: dict(link=("right_neck", "left_neck"), id=14, color=[255, 255, 255]),
        15: dict(
        ...
        16: dict(
            link=("medial_right_bow", "lateral_right_bow"), id=16, color=[255, 255, 255]
        ),
        17: dict(
        ...
        19: dict(
            link=("medial_left_bow", "lateral_left_bow"), id=19, color=[255, 255, 255]
        ),
        20: dict(
        ...
        21: dict(
            link=("medial_right_hip", "lateral_right_hip"), id=21, color=[255, 255, 255]
        ),
        22: dict(
        ...
        24: dict(
            link=("medial_left_hip", "lateral_left_hip"), id=24, color=[255, 255, 255]
        ),
        25: dict(
            link=("medial_left_knee", "lateral_left_knee"), id=25, color=[255, 255, 255]
        ),
        26: dict(
