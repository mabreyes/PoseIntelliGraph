dataset_info = dict(
    ...
    keypoint_info={
        ...
        7: dict(
            name="left_knee", id=7, color=[0, 255, 0], type="lower", swap="right_knee"
        ),
        8: dict(
            name="left_ankle", id=8, color=[0, 255, 0], type="lower", swap="right_ankle"
        ),
        9: dict(
            name="right_shoulder",
            id=9,
        ...
        15: dict(
            name="left_eye", id=15, color=[51, 153, 255], type="upper", swap="right_eye"
        ),
        16: dict(
            name="left_ear", id=16, color=[51, 153, 255], type="upper", swap="right_ear"
        ),
        17: dict(
            name="right_eye", id=17, color=[51, 153, 255], type="upper", swap="left_eye"
        ),
        18: dict(
            name="right_ear", id=18, color=[51, 153, 255], type="upper", swap="left_ear"
        ),
    },
    skeleton_info={
