dataset_info = dict(
    ...
    keypoint_info={
        0: dict(name="head_top", id=0, color=[51, 153, 255], type="upper", swap=""),
        ...
        8: dict(
            name="right_hip", id=8, color=[255, 128, 0], type="lower", swap="left_hip"
        ),
        9: dict(
        ...
        12: dict(
            name="left_knee", id=12, color=[0, 255, 0], type="lower", swap="right_knee"
        ),
        13: dict(
            name="left_ankle",
            id=13,
        ...
        14: dict(name="root", id=14, color=[51, 153, 255], type="lower", swap=""),
        15: dict(name="spine", id=15, color=[51, 153, 255], type="upper", swap=""),
        16: dict(name="head", id=16, color=[51, 153, 255], type="upper", swap=""),
    },
    skeleton_info={
        0: dict(link=("neck", "right_shoulder"), id=0, color=[255, 128, 0]),
        1: dict(link=("right_shoulder", "right_elbow"), id=1, color=[255, 128, 0]),
        2: dict(link=("right_elbow", "right_wrist"), id=2, color=[255, 128, 0]),
