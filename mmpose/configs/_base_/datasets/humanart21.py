dataset_info = dict(
    ...
    keypoint_info={
        ...
        19: dict(
            name="left_toe", id=19, color=[0, 255, 0], type="lower", swap="right_toe"
        ),
        20: dict(
            name="right_toe", id=20, color=[255, 128, 0], type="lower", swap="left_toe"
        ),
    },
    skeleton_info={
        ...
        19: dict(link=("left_ankle", "left_toe"), id=19, color=[0, 255, 0]),
        20: dict(link=("right_ankle", "right_toe"), id=20, color=[255, 128, 0]),
        21: dict(link=("left_wrist", "left_finger"), id=21, color=[0, 255, 0]),
        22: dict(link=("right_wrist", "right_finger"), id=22, color=[255, 128, 0]),
    },
    joint_weights=[
        1.0,
        1.0,
