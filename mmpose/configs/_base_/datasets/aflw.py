dataset_info = dict(
    ...
    keypoint_info={
        ...
        10: dict(name="kpt-10", id=10, color=[255, 0, 0], type="", swap="kpt-7"),
        11: dict(name="kpt-11", id=11, color=[255, 0, 0], type="", swap="kpt-6"),
        12: dict(name="kpt-12", id=12, color=[255, 0, 0], type="", swap="kpt-14"),
        13: dict(name="kpt-13", id=13, color=[255, 0, 0], type="", swap=""),
        14: dict(name="kpt-14", id=14, color=[255, 0, 0], type="", swap="kpt-12"),
