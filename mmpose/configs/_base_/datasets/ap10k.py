dataset_info = dict(
    ...
    keypoint_info={
        ...
        6: dict(
            name="L_Elbow", id=6, color=[51, 153, 255], type="upper", swap="R_Elbow"
        ),
        7: dict(name="L_F_Paw", id=7, color=[0, 255, 0], type="upper", swap="R_F_Paw"),
        8: dict(
            name="R_Shoulder", id=8, color=[0, 255, 0], type="upper", swap="L_Shoulder"
        ),
        9: dict(
            name="R_Elbow", id=9, color=[255, 128, 0], type="upper", swap="L_Elbow"
        ),
        10: dict(
            name="R_F_Paw", id=10, color=[0, 255, 0], type="lower", swap="L_F_Paw"
        ),
        11: dict(name="L_Hip", id=11, color=[255, 128, 0], type="lower", swap="R_Hip"),
        12: dict(
            name="L_Knee", id=12, color=[255, 128, 0], type="lower", swap="R_Knee"
        ),
        13: dict(
            name="L_B_Paw", id=13, color=[0, 255, 0], type="lower", swap="R_B_Paw"
        ),
        ...
        16: dict(
            name="R_B_Paw", id=16, color=[0, 255, 0], type="lower", swap="L_B_Paw"
        ),
    },
    skeleton_info={
