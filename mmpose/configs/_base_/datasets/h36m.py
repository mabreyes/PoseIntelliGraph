dataset_info = dict(
    ...
    keypoint_info={
        ...
        1: dict(
            name="right_hip", id=1, color=[255, 128, 0], type="lower", swap="left_hip"
        ),
        2: dict(
            name="right_knee", id=2, color=[255, 128, 0], type="lower", swap="left_knee"
        ),
        3: dict(
            name="right_foot", id=3, color=[255, 128, 0], type="lower", swap="left_foot"
        ),
        4: dict(
            name="left_hip", id=4, color=[0, 255, 0], type="lower", swap="right_hip"
        ),
        5: dict(
            name="left_knee", id=5, color=[0, 255, 0], type="lower", swap="right_knee"
        ),
        6: dict(
            name="left_foot", id=6, color=[0, 255, 0], type="lower", swap="right_foot"
        ),
    ...
    sigmas=[],
    stats_info=dict(bbox_center=(528.0, 427.0), bbox_scale=400.0),
)
