dataset_info = dict(
    ...
    keypoint_info={
        0: dict(name="neck", id=0, color=[255, 128, 0], type="upper", swap=""),
        1: dict(name="belly", id=1, color=[255, 128, 0], type="upper", swap=""),
        2: dict(name="head", id=2, color=[255, 128, 0], type="upper", swap=""),
        3: dict(
            name="right_shoulder",
            id=3,
            color=[0, 255, 0],
        ...
        5: dict(
            name="right_hip", id=5, color=[0, 255, 0], type="lower", swap="left_hip"
        ),
        6: dict(
            name="left_hip", id=6, color=[51, 153, 255], type="lower", swap="right_hip"
        ),
        7: dict(
            name="right_elbow",
            id=7,
    ...
    skeleton_info={
        ...
        10: dict(link=("right_elbow", "right_wrist"), id=10, color=[255, 128, 0]),
        11: dict(link=("neck", "left_shoulder"), id=11, color=[0, 255, 0]),
        12: dict(link=("left_shoulder", "left_elbow"), id=12, color=[0, 255, 0]),
