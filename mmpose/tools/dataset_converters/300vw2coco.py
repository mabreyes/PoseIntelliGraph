...
class Base300VW:
    def __init__(self):
        ...
        self.videos_train = [i for i in self.videos_full if i not in self.videos_test]
...
class Preprocess300VW(Base300VW):
    ...
    def _process_annotation(self, annot_path, image_id, anno_id):
        ...
        annotation = self._calculate_annotation_properties(annotation, keypoints)
    ...
    def convert_annotations(self, video_list=None, json_save_name="anno_300vw.json"):
        ...
        for video_id in video_list:
            ...
            for annot in annots:
                ...
                if (
                    video_id in self.broken_frames
                    and frame_num in self.broken_frames[video_id]
                ):
                ...
                annotation = self._process_annotation(annot_path, image_id, anno_id)
