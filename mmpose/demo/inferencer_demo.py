...
def parse_args():
    ...
    parser.add_argument(
        "inputs", type=str, nargs="?", help="Input image/video path or folder path."
    )
    ...
    parser.add_argument(
        "--scope", type=str, default="mmpose", help="Scope where modules are defined."
    )
    parser.add_argument(
        "--device",
        type=str,
    ...
    # call args
    parser.add_argument(
        "--show", action="store_true", help="Display the image/video in a popup window."
    )
    parser.add_argument(
        "--draw-bbox", action="store_true", help="Whether to draw the bounding boxes."
    )
    parser.add_argument(
        "--draw-heatmap",
        action="store_true",
