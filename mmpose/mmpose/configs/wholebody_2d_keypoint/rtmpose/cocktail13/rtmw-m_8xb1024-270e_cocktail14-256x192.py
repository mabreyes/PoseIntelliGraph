...
dataset_mpii = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=mpii_coco133)
    ],
)
...
dataset_jhmdb = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=jhmdb_coco133)
    ],
)
...
dataset_halpe = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=halpe_coco133)
    ],
)
...
dataset_wflw = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=wflw_coco133),
        *face_pipeline,
    ],
)
...
dataset_cofw = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=cofw_coco133),
        *face_pipeline,
    ],
)
...
dataset_lapa = dict(
    ...
    pipeline=[
        dict(type=KeypointConverter, num_keypoints=num_keypoints, mapping=lapa_coco133),
        *face_pipeline,
    ],
)
...
dataset_interhand2d = dict(
    ...
    camera_param_file="interhand26m/annotations/all/" "InterHand2.6M_train_camera.json",
