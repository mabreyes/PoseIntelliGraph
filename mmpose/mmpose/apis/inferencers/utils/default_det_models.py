...
default_det_models = dict(
    ...
    face=dict(
        model=osp.join(
            mmpose_path, ".mim", "demo/mmdetection_cfg/yolox-s_8xb8-300e_coco-face.py"
        ),
    ...
    hand=dict(
        model=osp.join(
            mmpose_path, ".mim", "demo/mmdetection_cfg/" "rtmdet_nano_320-8xb32_hand.py"
        ),
    ...
    animal=dict(
        model="rtmdet-m", weights=None, cat_ids=(15, 16, 17, 18, 19, 20, 21, 22, 23)
    ),
)
