...
class Hand3DHeatmap(BaseKeypointCodec):
    ...
    def __init__(
        ...
        self.scale_factor = (np.array(image_size) / heatmap_size[:-1]).astype(
            np.float32
        )
    ...
    def encode(
        ...
        rel_root_depth = (
            rel_root_depth / self.root_depth_bound + 0.5
    ...
    def decode(
        ...
        keypoints[..., 2] = (
            keypoints[..., 2] / self.depth_size - 0.5
        ) * self.heatmap3d_depth_bound
        ...
        rel_root_depth = (
            root_depth / self.root_heatmap_size - 0.5
