...
from mmpose.models.backbones.hrformer import HRFomerModule, HRFormer, HRFormerBlock
...
class TestHrformer(TestCase):
    def test_hrformer_module(self):
        ...
        self.assertEqual(feats[0].shape, torch.Size([1, num_inchannels[0], 64, 64]))
        self.assertEqual(feats[1].shape, torch.Size([1, num_inchannels[1], 32, 32]))
        ...
        self.assertEqual(feats[0].shape, torch.Size([1, in_channels[0], 64, 64]))
