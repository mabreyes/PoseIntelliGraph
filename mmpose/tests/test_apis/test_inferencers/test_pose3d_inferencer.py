...
class TestPose3DInferencer(TestCase):
    ...
    def test_init(self):
        ...
        inferencer = Pose3DInferencer(
            model="configs/body_3d_keypoint/video_pose_lift/h36m/video-pose-lift_tcn-243frm-supv-cpn-ft_8xb128-200e_h36m.py",  # noqa  # noqa
            weights="https://download.openmmlab.com/mmpose/body3d/videopose/videopose_h36m_243frames_fullconv_supervised_cpn_ft-88f5abbb_20210527.pth",  # noqa  # noqa
    ...
    def test_call(self):
        ...
        self.assertSequenceEqual(
            results1["predictions"][0][0]["keypoints"],
        ...
        inputs = (
            "https://user-images.githubusercontent.com/87690686/"
