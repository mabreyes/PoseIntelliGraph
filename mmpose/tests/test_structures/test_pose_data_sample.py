...
class TestPoseDataSample(TestCase):
    ...
    def test_setter(self):
        ...
        self.assertTrue(
            self._equal(
                data_sample.pred_instances.keypoints, pred_instances_data["keypoints"]
            )
        )
        self.assertTrue(
            self._equal(
                data_sample.pred_instances.scores, pred_instances_data["scores"]
            )
        )
        ...
        self.assertTrue(
            self._equal(data_sample.pred_fields.heatmaps, pred_fields_data["heatmaps"])
        )
